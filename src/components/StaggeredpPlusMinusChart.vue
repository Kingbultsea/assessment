<template>
    <div class="staggeredp-plus-minus-chart" :style="{color: colorFont}">
        ...
        <div class="line" v-for="(li, index) in chartConfig" :key="index">
            ...
            <div class="chart-bar">
                <div class="container">
                    <div :data-number="(li.percent / li.axis_max) * 100 + '%'" class="left-bar" :style="{width: (li.percent / li.axis_max) * 100 + '%', backgroundColor: (li.percent / li.axis_max) * 100 >= 50 ? colorA : colorB}"></div>
                </div>
                <div class="container">
